  ...
  return (
    <div className="explore-menu" id="explore-menu">
      ...
      <p className="explore-menu-text">
        ...
        with the finest ingredients culinary expertise. Our mission is to
        satisfy your cravings and elevate your dining experience, one delecious
        meal at a time.
      </p>
      <div className="explore-menu-list">
        {menu_list.map((items, index) => {
          return <div onClick={()=> SetCategory(prev => prev===items.menu_name ? "All" : items.menu_name)} key={index} className="explore-menu-list-items">
